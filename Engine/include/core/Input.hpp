...
public:
	...
	static bool MouseButtonPressed(MouseButtons btn);
	static bool MouseButtonJustPressed(MouseButtons btn);
	static bool MouseButtonReleased(MouseButtons btn);
	static bool MouseButtonJustReleased(MouseButtons btn);

	static bool keys[KEYS_MAX_KEYS];
	static bool prev_keys[KEYS_MAX_KEYS];

	static bool buttons[MOUSE_MAX_BUTTONS];
	static bool prev_buttons[MOUSE_MAX_BUTTONS];
